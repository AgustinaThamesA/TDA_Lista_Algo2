...
void inserta_elementos_en_lista() {
  ...
  pa2m_afirmar(lista_pruebas != 0 && lista->nodo_inicio->elemento == prueba_1 &&
...
void inserta_elementos_en_posicion_i_lista() {
  ...
  pa2m_afirmar(
      lista_pruebas != NULL && lista->nodo_inicio->elemento == prueba_2_1 &&
          ...
          lista->nodo_final->elemento == prueba_3 && lista->espacios == 4,
...
void quitar_elementos_en_lista() {
  ...
  lista_pruebas = lista_quitar(lista);
  pa2m_afirmar(
      lista_pruebas != NULL && lista->nodo_inicio->elemento == prueba_1 &&
          lista->nodo_final->elemento == prueba_1 && lista->espacios == 1,
...
void quitar_elemento_en_posicion_i_en_lista() {
  ...
  pa2m_afirmar(lista != NULL && lista->nodo_inicio->elemento == prueba_2 &&
                   lista->nodo_final->elemento == prueba_2 &&
                   lista->espacios == 1,
...
void iterador_interno_en_lista() {
  ...
  size_t cantidad = lista_con_cada_elemento(
      NULL, mostrar_para_prueba_iterador_interno, &cant_elementos_iterados);
  ...
  cantidad = lista_con_cada_elemento(
      lista, mostrar_para_prueba_iterador_interno, &cant_elementos_iterados);
  pa2m_afirmar(cantidad == 0 && cant_elementos_iterados == 0,
...
void buscar_elemento_en_lista() {
  ...
  pa2m_afirmar(buscador == NULL, "Buscador de un elemento que no existe "
...
void iterador_externo_en_lista() {
  ...
  pa2m_afirmar(iterador == NULL, "No se crea un iterador de una lista NULL.");
  ...
  iterador = lista_iterador_crear(lista);
  pa2m_afirmar(
      iterador->lista == lista && iterador->actual == lista->nodo_inicio,
  ...
  puede_avanzar = lista_iterador_avanzar(iterador);
  puede_avanzar = lista_iterador_avanzar(iterador);
  pa2m_afirmar(puede_avanzar == true && iterador->actual == lista->nodo_final,
...
void desapila_correctamente() {
  ...
  pa2m_afirmar(pila_desapilar(NULL) == NULL, "No desapila una pila NULL.");
...
void desencola_correctamente() {
  ...
  pa2m_afirmar(cola_desencolar(NULL) == NULL, "No desencola una cola NULL.");
...
void destruir_elemento(void *elemento) { free(elemento); }
...
void funcionalidad_lista_destruir_todo() {
  ...
  *elemento_2 = 2;
  ...
  pa2m_afirmar(
      lista_pruebas != 0 && lista->nodo_inicio->elemento == elemento_1 &&
          lista->nodo_final->elemento == elemento_2 && lista->espacios == 2,
